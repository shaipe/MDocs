...
📖 [Documentation / Demo](https://docs.htui.tech/)

💬 [Discord](https://discord.gg/9P5HzAz8DT)

## Quick Start

1. Create a project with the [starter template](https://github.com/shaip/mdocs)

  ```bash
  git clone https://github.com/shaip/mdocs.git [project-name]
  ```
